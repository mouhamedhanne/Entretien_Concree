      ...
      <Container>
        ...
        <div>
          <h2 className="font-extrabold mt-3 text-2xl sm:text-3xl text-center">
            Digitalisez et promouvez vos <br className="hidden sm:inline" />
            offres d'accompagnement
          </h2>
          <p className="text-center text-[14px] mt-2 px-4 sm:px-0">
            Accédez à une vaste communauté de porteurs de projets, d'entreprises
            et de <br className="hidden sm:inline" /> partenaires d'appui. Créez
            et gérez des offres de services sur mesure, et suivez
            <br className="hidden sm:inline" /> vos prestations étape par étape
            en toute simplicité
          </p>
        </div>

        <div className="flex flex-col sm:flex-row justify-center sm:space-x-4 w-full mt-8 px-4 sm:px-0">
          <div className="bg-white w-full sm:w-[40%] px-4 pt-4 pb-4 rounded-[8px] border border-[#AAB9C5] box-border mb-4 sm:mb-0">
            <div>
              <h4 className="font-extrabold text-xl sm:text-2xl mb-5">
                Gestion simplifiée et partagée
                <br className="hidden sm:inline" /> de votre structure
              </h4>
            </div>
            <div className="mt-2">
          ...
          <div className="bg-white w-full sm:w-[56%] px-4 pt-4 rounded-[8px] border border-[#AAB9C5] box-border">
            <div className="relative">
              ...
              <h4 className="font-extrabold text-xl sm:text-2xl">
                Parmi les structures déjà sur
                <br className="hidden sm:inline" /> Wekomkom
              </h4>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-5 justify-center items-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center sm:space-x-4 w-full mt-8 px-4 sm:px-0">
          <div className="bg-white w-full sm:w-[60%] px-4 pt-4 rounded-[8px] border border-[#AAB9C5] box-border mb-4 sm:mb-0">
            <div className="relative">
              <Image
                ...
                width={150}
                height={90}
                className="absolute top-7 left-[13rem] hidden sm:block"
              />
              <h4 className="font-extrabold text-xl sm:text-2xl">
                Votre plateforme WEKOMKOM <br className="hidden sm:inline" />
                c'est plus de :
              </h4>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-5 justify-center items-center">
          ...
          <div className="w-full sm:w-[36%] px-4 pt-4 pb-4 rounded-[8px] bg-gradient-to-r from-[#207280] to-[#3B9054]">
            <div className="block space-y-4">
              ...
              <div className="flex justify-center">
                <button className="flex items-center px-8 py-2 bg-white text-primary_button rounded-[2rem] text-sm sm:text-base">
