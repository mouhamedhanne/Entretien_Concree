...
export default function Entreprise() {
  return (
    <section className="bg-[#F7F9FC] pb-28 pt-10">
      <Container>
        ...
        <div>
          <h2 className="font-extrabold mt-2 text-4xl text-center">
         ...
         */}
        <div className="flex justify-center space-x-4 w-full mt-8">
          <div className="bg-white w-[44%] px-4 pt-4 pb-4 rounded-[8px]  border border-[#AAB9C5] box-border">
            <div>
              <h4 className="font-extrabold text-2xl">
          ...
          {/** */}
          <div className="bg-white w-[52%] px-2 pt-4 rounded-[8px] border border-[#AAB9C5] box-border">
            <div className="flex items-center -space-x-12">
              <div className="w-[49%] grid grid-rows-2 -space-y-2">
        ...
        <div className="w-full px-[14px] mt-8">
          <div className="relative bg-white w-full px-2 py-20 rounded-[8px] border border-[#AAB9C5] box-border overflow-hidden">
            ...
            <div className="relative max-w-2xl mx-auto text-center z-10">
              <h2 className="font-extrabold text-3xl mb-4 bg-gradient-to-r from-[#207280] to-[#3B9054] bg-clip-text text-transparent">
                Prêt à vous lancer ?
              </h2>
              <p className="text-[16px] mb-6">
                Créez votre entreprise maintenant et profitez de toutes <br />
            ...
            <Image
              ...
              width={120}
              height={120}
              className="absolute top-5 right-[4rem]"
            />
            <Image
